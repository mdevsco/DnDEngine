...
public enum DnDMagicSchool: String, Decodable {
    ...
    /// creatures to other planes of existence.
    case abjuration = "Abjuration"
    
    /// Conjuration spells involve the transportation of objects and creatures from one location
    /// to another. Some spells summon creatures or objects to the caster's side, whereas
    /// others allow the caster to teleport to another location. Some conjurations create objects
    /// or effects out of nothing.
    case conjuration = "Conjuration"
    
    /// Divination spells reveal information, whether in the form of secrets long forgotten,
    /// glimpses of the future, the locations of hidden things, the truth behind illusions, or visions
    /// of distant people or places.
    case divination = "Divination"
    
    /// Enchantment spells affect the minds of others, influencing or controlling their behavior.
    /// Such spells can make enemies see the caster as a friend, force creatures to take a course
    /// of action, or even control another creature like a puppet.
    case enchantment = "Enchantment"
    
    /// Evocation spells manipulate magical energy to produce a desired effect. Some call up
    /// blasts of fire or lightning. Others channel positive energy to heal wounds.
    ...
    /// that never happened. Some illusions create phantom images that any creature can see,
    /// but the most insidious illusions plant an image directly in the mind of a creature.
